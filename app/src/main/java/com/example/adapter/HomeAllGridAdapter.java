...
public class HomeAllGridAdapter extends ArrayAdapter<ItemLatest> {
    ...
    public HomeAllGridAdapter(Activity act, int resource, List<ItemLatest> arrayList, int columnWidth) {
